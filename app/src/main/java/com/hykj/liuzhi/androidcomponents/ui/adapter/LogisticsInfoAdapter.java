...
public class LogisticsInfoAdapter extends BaseQuickAdapter<ViewLogisticsBean.DataBeanX.DataBean, BaseViewHolder> {
    private Context context;
    private List<ViewLogisticsBean.DataBeanX.DataBean> data;

    public LogisticsInfoAdapter(Context context, int layoutResId, @Nullable List<ViewLogisticsBean.DataBeanX.DataBean> data) {
    ...
    @Override
    protected void convert(BaseViewHolder helper, ViewLogisticsBean.DataBeanX.DataBean item) {
